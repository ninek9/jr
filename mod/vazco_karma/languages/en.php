<?php
	...
	$english = array(	
		/*Settings*/
			...
			/*Settings actual*/
	      	'vazco_karma:settings:showPointsOnProfile' => 'Show Experience on profile page',
			'vazco_karma:settings:showPointsOnListings' => 'Show Experience on user listings',
...
Ranks have to be set from the lowest to the highest.',
		...
		/*Comunicates*/
		'vazco_karma:nopointsuser' => 'No user selected, or no Experience Points given.',
		'vazco_karma:pointsgiven' => 'User %s was assigned %s Experience Points.',
	
		'vazco_karma:givepoints' => 'Manage Experience Points',
	
		/*Titles*/
		'vazco_karma:userpoints' => 'User Experience Points',
		'vazco_karma:userpoints:current' => 'User %s has %s Experience Points.',
		'vazco_karma:userpoints:points' => 'Number of Experience Points to add/remove:',
		...
		/*User's profile page*/
		'vazco_karma:profile:points' => 'Experience Points:',
		'vazco_karma:profile:rank' => 'Experience Level:',
		'vazco_karma:exception:wrongparams' => 'Wrong Experience Level parameter. Levels need to be in format: LevelName|LevelPoints',
	
		/*Listing page*/
		'vazco_karma:listing:points' => 'Experience Points:',
		'vazco_karma:listing:rank' => 'Experience Level:',
		...
		'vazco_karma:settings:updateranks' => 'Update user Experience Points (useful when mounting the plugin)',
		'vazco_karma:updaterankssuccess' => 'Experience Points updated succesfully',
	
		/*History of points*/
		'vazco_karma:history:menu' => 'View history',
		'vazco_karma:history' => 'Points history',
		'vazco_karma:history:user' => 'User: <b>%s</b>',
		'vazco_karma:history:total' => 'Total number of Experience Points: <b>%s</b>',
		...
		'vazco_karma:menu:history' => 'My Experience Points',
