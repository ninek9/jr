...
<p>
	<?php echo elgg_echo("oi:widget:num_display"); ?>:
	<select name="params[num_display]">
		<option value="0" <?php if($vars['entity']->num_display == 0) echo "SELECTED"; ?>><?php echo elgg_echo('oi:widget:disabled'); ?></option>
...
<p>
    <?php echo elgg_echo("oi:widget:icon_size"); ?>
    <select name="params[icon_size]">
        <option value="1" <?php if($vars['entity']->icon_size == 1) echo "SELECTED"; ?>><?php echo elgg_echo("oi:widget:small"); ?></option>
	    <option value="2" <?php if($vars['entity']->icon_size == 2) echo "SELECTED"; ?>><?php echo elgg_echo("oi:widget:tiny"); ?></option>
    </select>
</p>