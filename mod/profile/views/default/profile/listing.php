<?php
	 ...
	 *
	 * modified for JockRoster theme. -eric 2/4/10
	 */
		...
		if (!$banned) {
			$info .= "<p><strong><a href=\"" . $vars['entity']->getUrl() . "\" rel=\"$rel\">" . $vars['entity']->name . "</a></strong></p>";
			
			//create a view that a status plugin could extend - in the default case, this is the wire
	 		$info .= "<div>" . elgg_view("profile/status", array("entity" => $vars['entity'])) . "</div>";
