<?php
	...
	// If we were given a correct icon
		if (
				...
				// modified for Jock Roster theme. extended max height so that profile image fills up horizontal space. -eric, 2-6-10
				$large = get_resized_image_from_uploaded_file('profileicon',200,999);
