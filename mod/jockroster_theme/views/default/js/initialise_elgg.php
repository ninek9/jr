...
function widget_state(forWidget) {
	...
	if (thisWidgetState == 'collapsed') {
		...
		$(forWidget).find("a.toggle_box_contents").html("<img src='<?php echo $vars['url']; ?>_graphics/jr/widgetmaximizebutton.png' />");
...
var toggleContent = function(e) {
	...
	if (targetContent.css('display') == 'none') {
		...
		$(this).html("<img src='<?php echo $vars['url']; ?>_graphics/jr/widgetminimizebutton.png' />");
		...
		$(this).html("<img src='<?php echo $vars['url']; ?>_graphics/jr/widgetmaximizebutton.png' />");
...
function widget_moreinfo() {
	...
	$("body").append("<p id='widget_moreinfo'><strong>"+ widgetdescription +" </strong></p>");
