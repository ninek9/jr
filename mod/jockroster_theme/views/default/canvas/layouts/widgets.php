...
<div id="profile_wrapper_left">
	
	<?php
	if (isset($vars['area1'])) echo $vars['area1'];	// profile box or 'dashboard info' notice
	?>
	
	<!-- left widgets -->
	<div id="widgets_left">
		<?php	
		// display rating plugin
		echo elgg_view('rate/rate', array('entity'=> $owner));
