		...
		<div id="widget<?php echo $vars['entity']->getGUID(); ?>">
			<div class="collapsable_box">
				<div class="collapsable_box_header">
					<a href="javascript:void(0);" class="toggle_box_contents"><img src="<?php echo $vars['url']; ?>_graphics/jr/widgetminimizebutton.png" /></a><?php if ($vars['entity']->canEdit()) { ?><a href="javascript:void(0);" class="toggle_box_edit_panel"><img src="<?php echo $vars['url']; ?>_graphics/jr/widgeteditbutton.png" /></a><?php } ?>
